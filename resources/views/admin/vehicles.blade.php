              ...
              <div class="row">
                <div class="col-sm-12 border-right">
                  <div class="description-block">
                    ...
                    <span class="description-text">VEHICLES IN THE UNIVERSE</span>
                  </div>
                  <a href="vehicle/{!! $data->vehicle_id; !!}" class="small-box-footer">See More info <i class="fa fa-arrow-circle-right"></i></a>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
